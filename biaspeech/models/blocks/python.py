...
class Python(block.Block):
    ...
    def get_file(self):
        ...
        conf.PYTHON_INPUT_A = conf.PYTHON_INPUT_A.replace("_OPENAI_API_KEY", os.environ['OPENAI_API_KEY'])  # replace
        conf.PYTHON_INPUT_A = conf.PYTHON_INPUT_A.replace("_OS", os.environ['OS'])  # replace
